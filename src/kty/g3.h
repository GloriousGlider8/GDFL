...
class g3_t : public kaitai::kstruct {

public:

    g3_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, g3_t* p__root = 0);
...
public:
     ...
     */
    uint8_t beard_goatee() const { return m_beard_goatee; }
     ...
     */
    uint8_t beard_size() const { return m_beard_size; }

    /**
     * Mustache type. Ranges from 0 to 5.
     */
    uint8_t beard_mustache() const { return m_beard_mustache; }

    /**
     * Mustache Y (vertical) position. Ranges from 16 to 0, low to high.
     */
    uint8_t beard_vertical() const { return m_beard_vertical; }
    ...
    g3_t* _root() const { return m__root; }
