...
class g4_t : public kaitai::kstruct {

public:

    g4_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, g4_t* p__root = 0);
...
private:
    ...
    std::vector<uint8_t>* m_unknown_buffer;
    uint8_t m_favorite_color;
    uint8_t m_gender;
    uint8_t m_body_height;
    uint8_t m_body_weight;
    std::vector<uint8_t>* m_unknown_buffer2;
    uint8_t m_face_type;
    ...
    std::vector<uint8_t>* m_unknown_buffer3;
    g4_t* m__root;
...
public:
     ...
     */
    std::vector<uint8_t>* unknown_data() const { return m_unknown_data; }
     ...
     */
    std::vector<uint8_t>* unknown_buffer() const { return m_unknown_buffer; }

    /**
     * Favorite color. Ranges from 0 to 11.
     */
    uint8_t favorite_color() const { return m_favorite_color; }
     ...
     */
    std::vector<uint8_t>* unknown_buffer2() const { return m_unknown_buffer2; }
     ...
     */
    uint8_t face_type() const { return m_face_type; }
     ...
     */
    uint8_t face_color() const { return m_face_color; }

    /**
     * Face wrinkles. Ranges from 0 to 11.
     */
    uint8_t face_wrinkles() const { return m_face_wrinkles; }

    /**
     * Face makeup. Ranges from 0 to 11.
     */
    uint8_t face_makeup() const { return m_face_makeup; }
     ...
     */
    uint8_t hair_color() const { return m_hair_color; }

    /**
     * Flip hair. 0 = no, 1 = yes.
     */
    uint8_t hair_flip() const { return m_hair_flip; }
     ...
     */
    uint8_t eye_type() const { return m_eye_type; }
     ...
     */
    uint8_t eye_color() const { return m_eye_color; }

    /**
     * Eye size. Ranges from 0 to 7, small to large.
     */
    uint8_t eye_size() const { return m_eye_size; }

    /**
     * Eye stretch. Ranges from 0 to 6, small to large.
     */
    uint8_t eye_stretch() const { return m_eye_stretch; }
     ...
     */
    uint8_t eye_rotation() const { return m_eye_rotation; }

    /**
     * Eye X (horizontal) distance. Ranges from 0 to 12, close to far.
     */
    uint8_t eye_horizontal() const { return m_eye_horizontal; }

    /**
     * Eye Y (vertical) position. Ranges from 18 to 0, low to high.
     */
    uint8_t eye_vertical() const { return m_eye_vertical; }
     ...
     */
    uint8_t eyebrow_type() const { return m_eyebrow_type; }
     ...
     */
    uint8_t eyebrow_color() const { return m_eyebrow_color; }

    /**
     * Eyebrow size. Ranges from 0 to 8, small to large.
     */
    uint8_t eyebrow_size() const { return m_eyebrow_size; }

    /**
     * Eyebrow stretch. Ranges from 0 to 6, small to large.
     */
    uint8_t eyebrow_stretch() const { return m_eyebrow_stretch; }
     ...
     */
    uint8_t eyebrow_rotation() const { return m_eyebrow_rotation; }

    /**
     * Eyebrow X (horizontal) distance. Ranges from 0 to 12, close to far.
     */
    uint8_t eyebrow_horizontal() const { return m_eyebrow_horizontal; }

    /**
     * Eyebrow Y (vertical) distance. Ranges from 18 to 3, low to high.
     */
    uint8_t eyebrow_vertical() const { return m_eyebrow_vertical; }
     ...
     */
    uint8_t nose_type() const { return m_nose_type; }

    /**
     * Nose size. Ranges from 0 to 8, small to large.
     */
    uint8_t nose_size() const { return m_nose_size; }

    /**
     * Nose Y (vertical) position. Ranges from 18 to 0, low to high.
     */
    uint8_t nose_vertical() const { return m_nose_vertical; }
     ...
     */
    uint8_t mouth_type() const { return m_mouth_type; }
     ...
     */
    uint8_t mouth_color() const { return m_mouth_color; }

    /**
     * Mouth size. Ranges from 0 to 8, small to large.
     */
    uint8_t mouth_size() const { return m_mouth_size; }

    /**
     * Mouth stretch. Ranges from 0 to 6, small to large.
     */
    uint8_t mouth_stretch() const { return m_mouth_stretch; }

    /**
     * Mouth Y (vertical) position. Ranges from 18 to 0, low to high.
     */
    uint8_t mouth_vertical() const { return m_mouth_vertical; }
     ...
     */
    uint8_t facial_hair_color() const { return m_facial_hair_color; }

    /**
     * Beard type. Ranges from 0 to 5.
     */
    uint8_t facial_hair_beard() const { return m_facial_hair_beard; }

    /**
     * Mustache type. Ranges from 0 to 5.
     */
    uint8_t facial_hair_mustache() const { return m_facial_hair_mustache; }

    /**
     * Mustache size. Ranges from 0 to 8, small to large.
     */
    uint8_t facial_hair_size() const { return m_facial_hair_size; }

    /**
     * Mustache Y (vertical) position. Ranges from 16 to 0, low to high.
     */
    uint8_t facial_hair_vertical() const { return m_facial_hair_vertical; }
     ...
     */
    uint8_t glasses_type() const { return m_glasses_type; }
     ...
     */
    uint8_t glasses_color() const { return m_glasses_color; }

    /**
     * Glasses size. Ranges from 0 to 7, small to large.
     */
    uint8_t glasses_size() const { return m_glasses_size; }

    /**
     * Glasses Y (vertical) position. Ranges from 20 to 0, low to high.
     */
    uint8_t glasses_vertical() const { return m_glasses_vertical; }

    /**
     * Enable mole. 0 = no, 1 = yes.
     */
    uint8_t mole_enable() const { return m_mole_enable; }

    /**
     * Mole size. Ranges from 0 to 8, small to large.
     */
    uint8_t mole_size() const { return m_mole_size; }

    /**
     * Mole X (horizontal) position. Ranges from 0 to 16, left to right.
     */
    uint8_t mole_horizontal() const { return m_mole_horizontal; }

    /**
     * Mole Y (vertical) position. Ranges from 30 to 0, low to high.
     */
    uint8_t mole_vertical() const { return m_mole_vertical; }

    /**
     * Currently unknown data - likely a 00 buffer between the Mii data and the Smash Ultimate data.
     */
    std::vector<uint8_t>* unknown_buffer3() const { return m_unknown_buffer3; }
    g4_t* _root() const { return m__root; }
