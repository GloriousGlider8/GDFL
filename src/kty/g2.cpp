...
g2_t::g2_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, g2_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_system_id = 0;
    m_avatar_id = 0;
...
void g2_t::_read() {
    ...
    m_creator_name = kaitai::kstream::bytes_to_str(m__io->read_bytes(20), std::string("utf-16le").c_str());
...
int32_t g2_t::eyebrow_horizontal() {
...
int32_t g2_t::facial_hair_beard() {
...
int32_t g2_t::facial_hair_mustache() {
...
int32_t g2_t::facial_hair_vertical() {
...
int32_t g2_t::facial_hair_color() {
...
int32_t g2_t::mole_enable() {
    if (f_mole_enable)
        return m_mole_enable;
    m_mole_enable = ((mole() >> 0) & 1);
    f_mole_enable = true;
    return m_mole_enable;
}

int32_t g2_t::favorite() {
    if (f_favorite)
        return m_favorite;
...
int32_t g2_t::glasses_vertical() {
    if (f_glasses_vertical)
        return m_glasses_vertical;
    m_glasses_vertical = ((glasses() >> 11) & 31);
    f_glasses_vertical = true;
    return m_glasses_vertical;
}

int32_t g2_t::favorite_color() {
    if (f_favorite_color)
